...
## Note:
**- <p align="justify"> File format details are provided to ensure count matrices are properly formatted when starting the workflow, specifically from the DGE analysis step </p>**
**- <p align="justify"> This pipeline requires species with high-quality gene feature information in GTF/GFF3 files </p>**
**- <p align="justify"> If the file lacks sufficient gene-level details, a count matrix will still be created, but it will miss required columns and fail at the DESeq2 step. In such cases, update the matrix manually and rerun DESeq2 </p>**
